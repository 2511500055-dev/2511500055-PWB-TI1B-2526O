...
if (isset($_POST['txtNim'])) {
  ...
  if (!empty($errors)) {
    ...
    redirect_ke('index.php#about'); // redirect ke biodata
  }

  // INSERT biodata
  $sql = "INSERT INTO tbl_aditya
  ...
  if (mysqli_stmt_execute($stmt)) {
    ...
    unset($_SESSION['old_biodata']); // hapus old value jika sukses
  } else {
...
if (isset($_POST['txtNama']) && !isset($_POST['txtNim'])) {
  ...
  if (!empty($errors)) {
    ...
    $_SESSION['old_contact'] = compact('nama','email','pesan','captcha');
