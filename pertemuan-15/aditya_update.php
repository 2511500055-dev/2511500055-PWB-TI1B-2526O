<?php
  ...
  if (!$cid) {
    ...
    redirect_ke('edit_aditya.php?cid='. (int)$cid);
  }
  ...
  if (mb_strlen($nama_lengkap) < 2) {
    $errors[] = 'Nama Lengkap minimal 2 karakter.';
  }

  if (mb_strlen($hobi) < 2) {
    $errors[] = 'Hobi minimal 2 karakter.';
  }

  if (mb_strlen($pekerjaan) < 2) {
    $errors[] = 'Pekerjaan minimal 2 karakter.';
  }

  if (mb_strlen($nama_orang_tua) < 2) {
    $errors[] = 'Nama Orang Tua 2 karakter.';
  }

  if (mb_strlen($nama_kakak) < 2) {
    $errors[] = 'Nama Kakak minimal 2 karakter.';
  }

  if (mb_strlen($nama_adik) < 2) {
    $errors[] = 'Nama Adik minimal 2 karakter.';
  }
  ...
  */
  ...
  /*
    ...
    (WAJIB WHERE cid = ?)
  */
  $stmt = mysqli_prepare($conn, "UPDATE tbl_aditya
  ...
  if (mysqli_stmt_execute($stmt)) { #jika berhasil, kosongkan old value
    ...
    */
    ...
    redirect_ke('aditya_read.php'); #pola PRG: kembali ke data dan exit()
